...
For more information on services and templates, check out [Services](./guides/services/Services.md).
...
For more information on the use of `make` in Kubails, see [Make as a Task Runner](./guides/MakeTaskRunner.md).
{% endhint %}
...
For a complete breakdown of all the infrastructure generated by Kubails, take a look at [Infrastructure](./guides/infrastructure/Infrastructure.md).
...
To learn more the CI/CD process and per branch deployments, check out [this page](./guides/PerBranchDeployments.md).
...
* Or maybe you want to learn [how to further configure Kubails](./guides/ProjectConfiguration.md)?
